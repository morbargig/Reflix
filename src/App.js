...
class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      movies: [
        ...
        { price: 10, id: 4, isRented: false, title: "The Sword in the Stone", year: 1963, img: "https://musicart.xboxlive.com/7/232a3700-0000-0000-0000-000000000002/504/image.jpg?w=1920&h=1080", descrShort: "Arthur is a young boy who just wants to be a knight's squire. Alas, he is dubbed 'Wart' early on, and it was all downhill from there for a while. On a hunting trip he falls in on Merlin, literally. Merlin is a possibly-mentally-unstable-and-ethically-dubious Wizard that turns Arthur into a literate, at-one-point harassed squirrel. Watch to find out what the heck that means." },
        { price: 15, id: 5, isRented: false, title: "Madagascar", year: 2005, img: "https://1.bp.blogspot.com/-b27jTqRUeFo/V_dkWR0V7pI/AAAAAAAAAFY/fu0o8yI6pSoC24PNqgY4QLEQ4BpU8ecUACLcB/s1600/download.jpg", descrShort: "A group of animals who have spent all their life in a New York zoo end up in the jungles of Madagascar, and must adjust to living in the wild.." },
      ],
      Budget: 50,
      isRented: []
    }
  ...
  isRented = (e) => {
    ...
    if (movies[e].isRented !== undefined && movies[e].isRented === false) {
...
let newMovie1 = {...newMovie}
    let movies = [...this.state.movies]
    console.log(newMovie.id, movies.length,movies.filter(m => m.id === newMovie.id)[0] !== undefined)
    if ( movies.filter(m => m.id === newMovie.id)[0] !== undefined ) {
      console.log("dflsnakjfbksjdabkj")
      movies.splice(newMovie.id, 1)      
    } else {
       newMovie1.newMovie = false
